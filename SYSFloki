...
contract SYSFloki is IERC20, Auth {
    using SafeMath for uint256;

    address WSYS = 0xa66b2E50c2b805F31712beA422D0D9e7D0Fd0F35; 
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "SYSFLOKI";
    string constant _symbol = "SYSFLOKI";
    ...
    constructor () Auth(msg.sender) {
        router = IDEXRouter(0x11C7a9EC6D27BbDf6abCef518e259d4E4d429DD6); //PEGASYS router
        ...
        devDeployReceiver = 0xf104c9b9A78140af5edcbBF438Fe129849b4B95C;
        marketingFeeReceiver = 0xf104c9b9A78140af5edcbBF438Fe129849b4B95C;
